...
import { insertDOAcceptanceApi, updateDOAcceptanceApi } from "../../../../services/api/do-acceptance.api";
...
export default function DOAcceptanceForm(props) {
    ...
    useEffect(() => {
        ...
        console.log(depoSwr?.data?.officers)
    }, [depoSwr.data])
    ...
    useEffect(() => {
        ...
        getListDepoApi({
            ...
            setDepoDestinations(res?.result)
        })
    }, [])
    ...
    function sendData() {
        if(checkValidation()) {
            ...
            if(props?.isEdit) {
                updateDOAcceptanceApi(data, props?.data?.id).then((res) => {
                    setLoading(false)
                    closeModal()
                ...
                insertDOAcceptanceApi(data).then((res) => {
                    setLoading(false)
                    closeModal()
        ...
        <div className="modal-wrapper" style={{width: "700px"}}>
            <Card className="modal">
                <div className="modal-header">
                    <h3>{props?.isEdit ? "Edit Do Acceptance" : "Add Do Acceptance"}</h3>
                </div>
                <div className="modal-content">
                    <div className="mb-3 text-left">
                        <InputLabel className="pb-1">
                            <Typography variant="caption">Acceptance Number</Typography>
                        </InputLabel>
                        <InputBase
                    ...
                    <div className="mb-3 text-left">
                        <InputLabel className="pb-1">
                            <Typography variant="caption">Acceptance Date</Typography>
                        </InputLabel>
                        <InputBase
                            name="date"
                            color="secondary"
                    ...
                    <Card className="mb-3 p-3 text-left" variant="outlined">
                        <div className="display-space-between mb-3">
                            <strong>Depot Acceptance</strong>
                        </div>
                        <div className="mb-3 text-left">
                            <InputLabel className="pb-1">
                    ...
                    <Card className="mb-3 p-3 text-left" variant="outlined">
                        <div className="display-space-between mb-3">
                            <strong>Acceptance Stock</strong>
                        </div>
                        <div className="mb-3 text-left">
                            <InputLabel className="pb-1">
                        ...
                        {(formState?.count ?? 0) > 0 && <div>
                            ...
                            <Autocomplete
                                ...
                                name="user"
                                value={null}
                                onChange={(event, value) => addStockList(value)}
                ...
                <div className="modal-footer">
                    <Button
                        ...
                        onClick={() => sendData()}
                        disableElevation>
                        {isLoading ? <CircularProgressCustom size={26} /> : (props?.isEdit ? "Edit Do Acceptance" : "Add Do Acceptance")}
                    </Button>
                </div>
            </Card>
        </div>
