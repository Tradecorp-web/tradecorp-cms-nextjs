...
import EirOutItem from "./eir-out-item";
...
export default function EirOutLayout(props) {
    ...
    function toCreatePage(e) {
        e.preventDefault()
        router.push(getRoute("depo.eir.out.create", {depoSlug: depoSlug}))
    }
    ...
    const renderMenu = (
        <Menu
            ...
            <MenuItem onClick={(e) => toCreatePage(e)}>Create EIR OUT</MenuItem>
        </Menu>
    );
    const sideBar = (
