...
import EirInForm from './eir-in-form';
                    ...
                    <Table aria-label="simple table">
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell>Loading Form</TableCell>
                        ...
                        <TableBody>
                          {!isLoading && dataList.map((data, index) => (
                              <TableRow key={index} hover={true}>
                                  <TableCell onClick={(e) => openDetail(e, getRoute('depo.eir.in.detail', {depoSlug: depoId, eirNo: data?.id}))}>{data?.eir_no}</TableCell>
                                  <TableCell onClick={(e) => openDetail(e, getRoute('depo.eir.in.detail', {depoSlug: depoId, eirNo: data?.id}))}>{dateFormat(data?.date_time)}</TableCell>
                                  <TableCell onClick={(e) => openDetail(e, getRoute('depo.eir.in.detail', {depoSlug: depoId, eirNo: data?.id}))}>{data?.container?.serial_number}x GP</TableCell>
                                  <TableCell onClick={(e) => openDetail(e, getRoute('depo.eir.in.detail', {depoSlug: depoId, eirNo: data?.id}))}>{data?.bl_no}</TableCell>
                                  <TableCell onClick={(e) => openDetail(e, getRoute('depo.eir.in.detail', {depoSlug: depoId, eirNo: data?.id}))}>{data?.consignee}</TableCell>
                                  <TableCell onClick={(e) => openDetail(e, getRoute('depo.eir.in.detail', {depoSlug: depoId, eirNo: data?.id}))}>{data?.loading_from}</TableCell>
                                  {/* <TableCell onClick={(e) => openDetail(e, getRoute('depo.eir.in.detail', {depoSlug: depoId, eirNo: data?.id}))}>{data?.created_by?.name}</TableCell> */}
                                  <TableCell onClick={(e) => openDetail(e, getRoute('depo.eir.in.detail', {depoSlug: depoId, eirNo: data?.id}))}>{data?.remarks}</TableCell>
                                  {/* <TableCell>
