...
import EirInLayout from "./eir-in-layout";

export default function EirInDetail(props) {
    ...
    if (!data) return (
        <EirInLayout eirNo={props?.eirNo}>
            <div>loading...</div>
        </EirInLayout>
    )

    return (
        <EirInLayout eirNo={props?.eirNo} title={`EIR IN: ${data?.id}`}>
            ...
            <Grid container className="mt-5">
                <Grid item xl={3} md={4}>
                    <div className="container-detail-wrapper">
                        ...
                        <div className="mb-3">
                            <div>
                                <Typography variant="caption" color="textSecondary" gutterBottom>B/L No</Typography>
                            </div>
                            <div>
                                <Typography variant="body1" gutterBottom>OFF HIRE</Typography>
                            </div>
                        </div>
                    </div>
                    <div className="mb-3">
                        <div>
                            <Typography variant="caption" color="textSecondary" gutterBottom>Consignee</Typography>
                        </div>
                        <div>
                    ...
                    <div className="mb-3">
                        <div>
                            <Typography variant="caption" color="textSecondary" gutterBottom>Ex. Vessel/Voy. No</Typography>
                        </div>
                        <div>
                    ...
                    <div className="mb-3">
                        <div>
                            <Typography variant="caption" color="textSecondary" gutterBottom>Loading From</Typography>
                        </div>
                        <div>
                    ...
                    <div className="mb-3">
                        ...
                        <div>
                            <Typography variant="body1" gutterBottom>IN</Typography>
                        </div>
                    </div>
                    <div className="mb-3">
                        <div>
