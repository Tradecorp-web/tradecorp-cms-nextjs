...
export default function EirInForm(props) {
            ...
            <div className="modal-wrapper" style={{width: "800px"}}>
                <Card className="modal">
                    <div className="modal-header">
                        <h3>{props?.isEdit ? "Edit Eir In" : "Add Eir In"}</h3>
                    </div>
                            ...
                            <Grid item md={6}>
                                <div className="mb-3 text-left">
                                    <InputLabel className="pb-1">
                                        <Typography variant="caption">B/L No</Typography>
                                    </InputLabel>
                                    <InputBase
                                        name="BLNo"
                                        color="secondary"
                                        className="input"
                                        value={formState?.BLNo}
                                        placeholder=""
                                ...
                                <div className="mb-3 text-left">
                                    <InputLabel className="pb-1">
                                        <Typography variant="caption">Consignee</Typography>
                                    </InputLabel>
                                    <InputBase
                                        name="consignee"
                                        color="secondary"
                                ...
                                <div className="mb-3 text-left">
                                    <InputLabel className="pb-1">
                                        <Typography variant="caption">Loading From</Typography>
                                    </InputLabel>
                                    <InputBase
                                        name="loadingFrom"
                                        color="secondary"
                                        className="input"
                                        value={formState?.loadingFrom}
                                        placeholder=""
                                        onChange={onChangeInput}
                                        fullWidth>
                                    </InputBase>
                    ...
                    <div className="modal-footer">
                        <Button
                            ...
                            onClick={() => sendData()}
                            disableElevation>
                            {isLoading ? <CircularProgressCustom size={26} /> : (props?.isEdit ? "Edit Eir In" : "Add Eir In")}
                        </Button>
                    </div>
                </Card>
            </div>
