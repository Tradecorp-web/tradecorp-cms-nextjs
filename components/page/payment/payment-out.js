...
export default function Page() {
  ...
  return (
    <BaseLayout title="Create Bill Payment">
      <div className={classes.root}>
        <Box container spacing={2}>
          <Box item xs={12}>
            <Typography variant="subtitle1">Create Bill Payment</Typography>
          </Box>
        </Box>
        <Box container spacing={2}>
          <Box item xs={12}>
          ...
          <Box item xs={12} style={{ textAlign: "center" }}>
            <div className={classes.rootmenu}>
              ...
              <Button
                variant="contained"
                color="default"
                onClick={(e) => openPage(e, getRoute("payment-in"))}
              >
        ...
        <Paper className={classes.paper}>
          <Box container spacing={2}>
            <Box item>
              <ButtonBase>
                <Icon style={{ fontSize: 30, color: "#5d6d7e" }}>payment</Icon>
              </ButtonBase>{" "}
            </Box>
            ...
            <Box container spacing={2}>
              <Box>
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={6}>
                    <Typography className={classes.labelbase}>Bank</Typography>
                  </Grid>
                </Grid>
              </Box>
              <Box>
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={6}>
                    <Select
                      ...
                      fullWidth
                    >
                      <MenuItem value="cash">Mandiri [ 11029301901 ]</MenuItem>
                      <MenuItem value="bank">BCA [ 392001920 ]</MenuItem>
                    </Select>
                  </Grid>
                </Grid>
              </Box>
          ...
          <Box container spacing={2}>
            ...
            <Box item xs={10}>
              <NumberFormat
                ...
                variant="outlined"
                fullWidth
                // onChange={(e, v) => onInputDetailChange(e, v, true, index)}
