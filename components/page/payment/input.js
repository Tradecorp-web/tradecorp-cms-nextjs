...
import { insertPaymentApi } from "../../../services/api/payment.api";
...
export default function Page() {
  ...
  return (
    <BaseLayout title="Create Payment">
      <div className={classes.root}>
        ...
        <Paper className={classes.paper}>
          ...
          <Box container spacing={2} xs={12}>
            <Box item xs={2}>
              <Typography className={classes.labelbase}>Project</Typography>
            </Box>
            <Box item xs={10}>
              <Autocomplete
                className={classes.inputbase}
