...
import FormOrder from "./form-order-completed";
...
export default function BuildQuoteInput() {
  ...
  useEffect(async () => {
    var data = await getListOrderIdStatusQuoteApi(quoteinId, "completed");
          ...
          <Grid container className="mt-3">
            <Grid xs={6}>
              <ButtonGroup>
                <Button
                  style={{ marginLeft: 7 }}
                  onClick={(e) => openPage(e, getRoute("quotein-completed"))}
                >
