...
import { saveMultiFolderUserApi,purgeFolderUserApi } from "../../../services/api/folder-user.api"
...
export default function DocumentForm(props) {
    ...
    const uploadFile = (file,len,folder_id="") => {
        uploadFileMyApi(folder,file,(event) => {
    ...
    const processListFile = (files,no) => {
        ...
        if (section.length > 1) {
            ...
            saveMultiFolderUserApi(stack).then((res) => {
