...
export default function Page(props) {
  ...
  let period_acc = "Supplier  : " + period;
  return (
                  ...
                  <Table aria-label="simple table">
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell>
                          <div style={{ textAlign: "center" }}>Supp Code</div>
                        </TableCell>

                        <TableCell>
                          <div style={{ textAlign: "center" }}>Supp Name</div>
                        </TableCell>
                        <TableCell>
                    ...
                    <TableBody>
                      ...
                      <TableCell>
                        <div style={{ textAlign: "center" }}>201102</div>
                      </TableCell>
                      <TableCell>
                        <div style={{ textAlign: "center" }}>PT. XYZ</div>
                      </TableCell>
                      <TableCell>
                        <ButtonGroup variant="outlined" color="default">
                    ...
                    <TableBody>
                      ...
                      <TableCell>
                        <div style={{ textAlign: "center" }}>201103</div>
                      </TableCell>
                      <TableCell>
                        <div style={{ textAlign: "center" }}>PT. XYZZ</div>
                      </TableCell>
