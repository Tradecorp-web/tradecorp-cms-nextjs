        ...
        >
          <Grid item lg={12}>
            <Card className="{classes.root}">
              <CardHeader title="Cash Flow" subheader={period_acc}></CardHeader>
              <CardContent>
                  ...
                  <Table aria-label="simple table">
                    <TableHead>
                      ...
                      <TableRow>
                        ...
                        <TableCell>
                          <div style={{ textAlign: "left" }}>Acc. Code</div>
                        </TableCell>

                        <TableCell>
                          <div style={{ textAlign: "left" }}>Acc. Name</div>
                        </TableCell>
                    ...
                    <TableBody>
                      ...
                      <TableCell>
                        <div style={{ textAlign: "left" }}>1140</div>
                      </TableCell>
                      <TableCell>
                        <div style={{ textAlign: "left" }}>
                          Account Receivable
                    ...
                    <TableBody>
                      ...
                      <TableCell>
                        <div style={{ textAlign: "left" }}>6011</div>
                      </TableCell>
                      <TableCell>
                        <div style={{ textAlign: "left" }}>Gaji</div>
                      </TableCell>
                      <TableCell>
                        <div style={{ textAlign: "right" }}>-10.000.000</div>
                      </TableCell>
                      <TableCell>
                        <div style={{ textAlign: "right" }}>-10.000.000</div>
                      </TableCell>
