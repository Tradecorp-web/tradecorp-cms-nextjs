        ...
        <Grid container spacing={6}>
          <Grid item lg={3}>
            <Link
              ...
              button
              onClick={(e) =>
                openPage(e, getRoute("accounting.transaction.purchase.vendor"))
              }
              className={classes.menuItem}
            >
          ...
          <Grid item lg={3}>
            <Link
              ...
              onClick={(e) =>
                openPage(
                  e,
                  getRoute("accounting.transaction.purchase.material")
                )
              }
              className={classes.menuItem}
            >
            ...
            >
              <div className="card card-hover mb-12">
                ...
                <div className="flex-center">
                  ...
                  <small className="text-muted">Account Payable</small>
                </div>
                <CardContent>
                  <Typography
                    className="mb-12"
