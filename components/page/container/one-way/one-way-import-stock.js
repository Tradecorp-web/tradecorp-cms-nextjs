...
export default function OneWayImportStock(props) {
                ...
                <Table aria-label="simple table">
                    ...
                    {data.map((item, index) => (
                        <TableRow key={index} hover={true}>
                            <TableCell onClick={() => deleteContainerByIndex(index)}>{index + 1}</TableCell>
                            <TableCell onClick={() => deleteContainerByIndex(index)}>{item[0]}</TableCell>
                            <TableCell onClick={() => deleteContainerByIndex(index)}>{item[1]}/{item[2]}</TableCell>
                            <TableCell onClick={() => deleteContainerByIndex(index)}>{item[7]}-{item[8]}</TableCell>
