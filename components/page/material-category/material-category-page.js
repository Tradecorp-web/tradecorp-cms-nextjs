...
import MaterialForm from "./material-category-form";
import TablePaginationActions from "@material-ui/core/TablePagination/TablePaginationActions";
import { CircularProgressCustom } from "../../base_component/spinner";
import { getListMaterialCategorySwr } from "../../../services/swr/material-category.swr";
import { deleteMaterialCategoryApi } from "../../../services/api/material-category.api";
...
export default function Page() {
    ...
    async function deleteData() {
        ...
        await deleteMaterialCategoryApi(data?.id)
        setEditData(null)
    }
    // --------< Delete Data >--------
    ...
    var listMaterialSwr = getListMaterialCategorySwr({
        search: search, 
        page: page+1, 
        limit: limit,
        orderBy: "name",
    ...
    return <BaseLayoutProduct>
        <div className="p-5 content-wrapper">
            <Grid container className="page-container" alignItems="center" justify="center">
                <Grid item xs={12} lg={8}>
                    <h1 className="mb-3">Materials Category</h1>
                    <div className="card no-padding">
                        <div className="p-3 display-space-between">
                            <div className="display-space-between" style={{width: "25%"}}>
                                <IconButton onClick={() => router.push(getRoute("material"))} size="small" className="me-3"><Icon>arrow_back</Icon></IconButton>
                            ...
                            <Button
                                ...
                                <Icon>add</Icon>Add Material Category
                            </Button>
                        </div>
                        <Divider/>
        ...
        <MaterialForm 
            ...
            dataUpdated={(data) => listMaterialSwr.mutate()} />
        <AlertDialog 
            title="Delete Item"
