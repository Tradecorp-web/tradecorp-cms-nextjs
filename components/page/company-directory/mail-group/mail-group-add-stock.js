...
export default function MailGroupAddStock(props) {
        ...
        {!isShowSelectedContainers && <div className="card no-padding">
            <div className="p-3 display-space-between">
                ...
                <ButtonGroup variant="outlined" color="default"aria-label="split button">
                    <Button
                        onClick={() => props?.close()}>
                        <Icon className="me-2">close_circle</Icon>
                    </Button>
                    <Button
                    ...
                    <Button
                        ...
                        <Icon className="me-2" color="secondary">check_circle</Icon>Add List to Lease Agreement
                    </Button>
                </ButtonGroup>
            </div>
            <Divider />
        ...
        {isShowSelectedContainers && <div className="card no-padding">
            <div className="p-3 display-space-between">
                ...
                <ButtonGroup variant="outlined" color="default"aria-label="split button">
                    ...
                    <Button
                        onClick={() => confirmContainerListSelected(true)}>
                        <Icon className="me-2" color="secondary">check_circle</Icon>Add List to Lease Agreement
                    </Button>
                </ButtonGroup>
            </div>
