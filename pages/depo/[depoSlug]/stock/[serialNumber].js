...
const PageLayout = dynamic(() => import('../../../../components/page/depo/stock-container/stock-container-detail'), {
    loading: () => (
      <Loading />
    ),
    ssr: false,
...
const Index = ({serialNumber}) => {
    ...
    return (
        <PageLayout serialNumber={serialNumber} />
    )
}
