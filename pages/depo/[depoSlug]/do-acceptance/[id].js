...
const PageLayout = dynamic(() => import('../../../../components/page/depo/do-acceptance/do-acceptance-detail'), {
    loading: () => (
      <Loading />
    ),
    ssr: false,
...
const Index = ({referenceNumber}) => {
    ...
    return (
        <PageLayout referenceNumber={referenceNumber} />
    )
}
