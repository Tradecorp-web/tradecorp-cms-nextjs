...
const PageLayout = dynamic(() => import('../../../components/page/warehouse/material-out/list-material-out'), {
    loading: () => (
      <Loading />
    ),
    ssr: false,
    ...
    useEffect(() => {
        ...
        if(res) {
            if (!isPermit("menu","warehouse")) {
                ...
                localStorage.setItem(LOCAL_STORAGE_MESSAGE, "You don't have permission on Warehouse Menu")
                router.push('/')
            }
        } else {
