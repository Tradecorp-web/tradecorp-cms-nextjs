...
const PageLayout = dynamic(() => import('../../../components/page/driver-job/driver-job-page'), {
    loading: () => (
      <Loading />
    ),
    ssr: false,
    ...
    useEffect(() => {
        ...
        if(res) {
            if (!isPermit("menu","driver")) {
                ...
                localStorage.setItem(LOCAL_STORAGE_MESSAGE, "You don't have permission on Driver Management")
                router.push('/')
            }
        } else {
